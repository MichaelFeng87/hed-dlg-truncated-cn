...
class MatchTopicReply(object):
    def __init__(self):
        ...
        if mode == 'prod':
            ...
            self.unk = "<unk>"
            self.train_path = './raw_data/ajmd_demo_train.txt'
            self.valid_path = './raw_data/ajmd_demo_valid.txt'
            self.test_path = './raw_data/ajmd_demo_test.txt'
